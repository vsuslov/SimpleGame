...
public abstract class SimpleObject extends GameObject implements Renderable {
    ...
    public SimpleObject(Side side, Game game) {
        ...
        float x =
                (Side.ENEMY.equals(this.side)) ? this.game.getGraphics()
    ...
    public void render() {
        ...
        game.getGraphics().drawRect(getRenderPosition(lowerLeft), bounds.width,
    ...
    public Vector getRenderPosition(Vector v) {
        ...
        Vector pos = v.cpy();
        pos.y = game.getGraphics().getHeight() - pos.y;
        return pos.cpy();
    }
}
